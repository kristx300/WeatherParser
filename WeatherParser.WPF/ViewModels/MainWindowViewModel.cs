...
internal class MainWindowViewModel : NotifyPropertyChangedBase
{
    ...
    public MainWindowViewModel(WeatherDataProtoGismeteo.WeatherDataProtoGismeteoClient weatherParserService,
        ITimerSaveData timerSaveData)
    {
        timerSaveData.SaveData();

        Series = new ObservableCollection<ISeries>();
        XAxes = new ObservableCollection<Axis>();
        YAxes = new ObservableCollection<Axis> { new() };
    ...
    public DateTime? SelectedDate
    {
        ...
        set
        {
            ...
            for (var i = 0; i < Times.Count; ++i) Times[i].IsDateChecked = true;
        }
    }
    ...
    public ObservableCollection<TimeViewModel> Times { get; } = new();
